...
$uri = 'mongodb+srv://ruifeng:2Z9UTRNdTdDTCOdD@cluster0.1un9blx.mongodb.net/?retryWrites=true&w=majority';
                ...
                try {
                    ...
                    foreach ($cursor as $document) {
                        ...
                        // Check if the book is owned, if not, skip to the next iteration
                        if (!$isOwned) {
                            continue;
                        }

                        $ownedClass = 'owned'; // Define a CSS class for owned books

                        echo "<div class='card_container content col-lg-3 col-md-6 col-sm-6 col-12 active $ownedClass' data-category='" . strtolower(str_replace('|', ' ', $document->genres)) . "'>" .
                        ...
                        "<div class='card-body $ownedClass'>" . // Add owned class to card-body
                        ...
                        "<p class='card-owned'><strong>Owned</strong></p>" . // Display additional information for owned books
                        "</div>" .
                        "</div>" .
                        "</a>" .
                        "</div>";
